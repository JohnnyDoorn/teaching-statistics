---
title: "Bayesian Statistics: Posterior Inference & Hypothesis Testing"
...
- Summarize posterior distributions using point estimates and credible intervals.
- Evaluate interval hypotheses using posterior probabilities and Bayes factors.
- Assess point hypotheses using Bayes factors.
- Compute Bayes factors using prior/posterior odds and the Savage–Dickey density ratio.
:::

::: setup
**Recommended Reading** 

- *Bayes Rules!* - Chapter 8.1–8.2
- Course addendum: _Testing Point Hypotheses_
...
- **Bayesian Foundations (Chapters 1–3)**  
  We introduced the core elements of a Bayesian model:  
  the **prior** (our beliefs before seeing data),  
  the **likelihood** (how data relate to parameters), and  
  the **posterior** (updated beliefs after seeing data).  
  These are connected by Bayes’ Rule:  
  $${\text{Posterior}} \propto {\text{Likelihood}} \times {\text{Prior}}$$

- **Sequential Updating & Prior Sensitivity (Chapter 4)**  
  We saw how new data can be incorporated over time, and how the informativeness of the prior shapes the resulting posterior.

- **Conjugate Models (Chapter 5)**  
  We explored conjugate pairs like **Beta-Binomial**, **Gamma-Poisson**, and **Normal-Normal**. These models allow closed-form posterior updates and give us analytical insight into parameters like probabilities ($\pi$) and means ($\mu$).

---

**Today**, we build on those foundations to develop tools for drawing conclusions from posterior distributions:

- Construct **credible intervals** to summarize parameter uncertainty  
- Use **Bayes factors** to compare both interval and point hypotheses  
- Apply the **Savage–Dickey density ratio** as a shortcut for testing point hypotheses
:::
...
Next, we’ll use these tools to begin testing hypotheses. Starting with **interval claims** like "Is the failure rate below 2/month?"
...
In this lecture, we extended Bayesian inference beyond estimation — developing tools to test hypotheses and compare models using the posterior.


### Summary

* **Posterior summaries** help quantify uncertainty and describe what we’ve learned from the data.
* **Posterior probabilities** allow us to directly assess claims like “the rate is below 1.5” or “the parameter lies between 0.25 and 0.35” — these are known as **interval hypotheses**.
* **Bayes factors** provide a formal method for comparing models or hypotheses by quantifying the evidence in the data.
* The **Savage–Dickey method** offers a shortcut to compute Bayes factors for **point hypotheses** in nested models.

These ideas form the bridge from Bayesian reasoning to decision-making and predictive modeling — the topics we’ll take up next.

::: nextsteps
To consolidate your understanding and prepare for the upcoming **exam** and **group assignment**:
...
* Cross-check your results using JASP <img src="JASP_logo.svg" alt="JASP logo" style="height:1em; vertical-align:text-bottom;">

**Extra Resources**:

* Office hour: Wednesday 10:00–11:00, G0.36
* [Alicia Johnson's course material](https://ajohns24.github.io/454_Fall_21/index.html) (includes examples, and exercises)
:::

As always, don’t hesitate to reach out during office hours if you want to explore these ideas further.