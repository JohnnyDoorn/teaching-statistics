...
- **Grid approximation & MCMC**: identify a sampling recipe described on the page, explain why a non-conjugate posterior has no closed form, compute a one-step Metropolis acceptance probability, diagnose chain mixing from trace plots
