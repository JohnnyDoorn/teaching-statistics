---
title: "Lecture 3 — Conjugate Models & Choosing Your Prior (Ch. 5)"
...
format:
  html:
    ...
    self-contained: true
  revealjs:
    output-file: lecture3_conjugacy_slides.html
    theme: simple
    css: ajohnson.css
    slide-number: true
    scrollable: true
...
2. Simulate $y^{(i)}$ using the binomial PMF at each $\theta^{(i)}$
