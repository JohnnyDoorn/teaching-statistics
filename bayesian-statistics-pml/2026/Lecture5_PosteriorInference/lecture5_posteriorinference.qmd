...
- A **credible interval for $\lambda$** tells you about our knowledge of the *mean* rate of failures. It's narrow when you have lots of data.
...
This represents **substantial evidence** ([Example](https://johnnydoorn.github.io/IntroductionBayesianInference/02-models.html#fig-bayes-factor-classification)) in favor of the alternative hypothesis, according to conventional interpretive scales.
