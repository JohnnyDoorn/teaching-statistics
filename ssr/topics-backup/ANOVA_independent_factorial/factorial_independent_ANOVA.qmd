...
plotSumSquaresFactorial(mydat, input = input, sumSq = "Model", myMain = "Full Model SS",
...
input$whatPred <- "Alcohol + Speed + A:S"
input$whatDisplay <- c("Segments", "Sums")
    plotSumSquaresFactorial(mydat, input = input, sumSq = "Error", myMain = "Full Model SS Error",
                   alcColors = palette.colors(n = 3, palette = "Okabe-Ito"),
                   speedSymbols = c(21, 22, 23)) 
```
...
input$whatDisplay <- c("Segments", "Sums")
    plotSumSquaresFactorial(mydat, input = input, sumSq = "Model", myMain = "Speed Model SS",
                   alcColors = palette.colors(n = 3, palette = "Okabe-Ito"),
                   speedSymbols = c(21, 22, 23)) 
```
...
input$whatPred <- "Speed"
input$whatDisplay <- c("Segments", "Sums")
    plotSumSquaresFactorial(mydat, input = input, sumSq = "Error", myMain = "Speed Model SS",
                   alcColors = palette.colors(n = 3, palette = "Okabe-Ito"),
...
input$whatDisplay <- c("Segments", "Sums")
    plotSumSquaresFactorial(mydat, input = input, sumSq = "Model", myMain = "Alcohol Model SS",
                   alcColors = palette.colors(n = 3, palette = "Okabe-Ito"),
                   speedSymbols = c(21, 22, 23)) 
```
...
input$whatPred <- "Alcohol"
input$whatDisplay <- c("Segments", "Sums")
    plotSumSquaresFactorial(mydat, input = input, sumSq = "Error", myMain = "Alcohol Model SS",
                   alcColors = palette.colors(n = 3, palette = "Okabe-Ito"),
                   speedSymbols = c(21, 22, 23), overlayFullPred = FALSE) 
```
