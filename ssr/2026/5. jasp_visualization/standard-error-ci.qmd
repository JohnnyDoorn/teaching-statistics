...
You already know how to standardize a single value into a z-score. A sample *mean* varies from sample to sample too, so the same question applies: how far off is it, typically?
