...
<img src="../../images/iq-form-2026.png" style="width:20%;"/>

<!-- <p style="font-size: 30px;"> https://edu.nl/aja6j</p> -->
...
```{r onesample-load-iq-data, message=FALSE, eval=TRUE, echo=FALSE}
source("../../_setup.R")
iqThisYear     <- iqYear()
...
```{r onesample-sample-summary, message=FALSE, warning=FALSE, echo=TRUE}
mu     <- 120
...
<small>
Does this mean differ significantly from $H_0:$ $\mu = `r mu`$?
</small>
...
```{r onesample-t-statistic, echo=TRUE}
...
```{r onesample-p-value-two-sided, echo=FALSE, fig.align = 'center'}
df <- n-1
...
```{r onesample-p-value-one-sided-positive, echo=FALSE, fig.align = 'center'}
...
```{r onesample-p-value-one-sided-negative, echo=FALSE, fig.align = 'center'}
...
- See [here](https://johnnydoorn.github.io/teaching-statistics/extra-texts/eff-size-vs-test-stat.html) for additional ramblings

$$d = \frac{t}{\sqrt{n}}$$

```{r onesample-effect-size-d, echo=TRUE}
d <- tStat / sqrt(n)
