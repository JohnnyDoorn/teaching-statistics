...
::: {.column}
![](../../images/linear-vs-nonlinear.png)
:::
...
```{r reg-the-slope-rise-run, fig.align='center', fig.width=8, fig.height=6, echo=FALSE}
# Extra
...
```{r reg-residuals-qq, fig.height=5, fig.width=5, fig.align='center', echo=FALSE}
qqnorm(error,
       main = "QQ Plot of Residuals",
       xlab = "Theoretical Quantiles",
       ylab = "Sample Quantiles",
...
```{r reg-residuals-hist, fig.height=5, fig.width=5, fig.align='center', echo=FALSE}
hist(error,
