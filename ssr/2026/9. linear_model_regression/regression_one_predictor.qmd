...
cov(sales, adverts)    # same association, but only readable in GBP1,000 x 1,000 copies
...
b1 # how much does y-prediction increase, if we increase x by 1 unit?
   # .096: one extra GBP1,000 of advertising buys about 96 extra copies
...
cor(sales, prediction) # can be squared to get proportion explained variance
                       # .58 here, because one predictor *is* the whole model;
