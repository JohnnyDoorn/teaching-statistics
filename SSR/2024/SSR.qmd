...
data.frame(Date    = lectures$date, 
           ...
           Handout = sprintf('<a href="https://JohnnyDoorn.github.io/teaching-statistics/%s" target="_blank" class="external">link</a>', gsub("qmd", "html", lectures$url)),
           Slides  = sprintf('<a href="https://JohnnyDoorn.github.io/teaching-statistics/%s" target="_blank" class="external">link</a>', gsub("qmd", "slide.html", lectures$url)) 
          ) -> lecture.list
