...
data.frame(Date    = lectures$date, 
           ...
           Handout = sprintf('<a href=".../%s" target="_blank" class="external">link</a>', gsub("qmd", "html", lectures$url)),
           Slides  = sprintf('<a href=".../%s" target="_blank" class="external">link</a>', gsub("qmd", "slide.html", lectures$url)) 
          ) -> lecture.list
