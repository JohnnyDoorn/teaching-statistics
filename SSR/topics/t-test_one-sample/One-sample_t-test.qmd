...
::: {.r-stack}
<img src="nomaphochs.png" style="width:40%;"/>

<p style="font-size: 30px;">https://maglit.me/nomaphochs</p>
...
library("gsheet")
data <- gsheet2tbl('https://docs.google.com/spreadsheets/d/1LN8j2MgTk1Su-hZCbFjexiUKQx-LmbgGqlpN6YzF2jQ/edit?usp=sharing')

# IQ.next.to.you = data[grep("2017|2020", as.character(data$Timestamp)),"IQ next to you"]
IQ.next.to.you = data[,"nextIQ"]
IQ.next.to.you <- as.numeric(IQ.next.to.you$nextIQ)
```
