...
data <- read.csv(datasetsPath("drug_long.csv"))[, -3]
...
## Example
[Link](https://discoverjasp.com/repository/dsj1_data/data/drug_long.jasp)
...
## Test statistic W is the sum of ranks per group {.subsection}
...
```{r, echo=FALSE, warning=FALSE, fig.align='center'}
visualize_normal_base(z, side = "negative")
```
