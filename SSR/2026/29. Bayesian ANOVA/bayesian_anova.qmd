...
```{r, echo=FALSE}
source("../../_setup.R")
dat <- read.csv(datasetsPath("beerTastingData.csv"))
x <- dat$AlcRating
y <- dat$NonAlcRating
grandM <- mean(c(x,y))
x <- (x - grandM)  / sd(x)
...
<img src="../../images/ANOVA_ModelComparison.png" alt="Bayes factor table" width="900"/>
</div>


## Looking at the individual effects
<div style="text-align: center;">
<img src="../../images/ANOVA_AnalysisEffects.png" alt="Bayes factor table" width="900"/>
</div>


## Single model inference
<div style="text-align: center;">
<img src="../../images/ANOVA_SingleModelInferenceMainEffects.png" alt="Bayes factor table" width="900"/>
</div>

## Single model inference: Posterior for BeerType
<div style="text-align: center;">
<img src="../../images/ANOVA_BeerType.png" alt="Bayes factor table" width="550"/>
</div>

## Single model inference: Posteriors for CorrectIdentify
<div style="text-align: center;">
<img src="../../images/ANOVA_CorrectIdentify.png" alt="Bayes factor table" width="450"/>
</div>

## Lost?
<div style="text-align: center;">
<img src="../../images/info.png" alt="Info button in JASP" width="200"/>
</div>

## JASP
<div style="text-align: center;">
<img src="../../images/JASP_logo_green.svg" alt="JASP" width="200"/>
</div>
