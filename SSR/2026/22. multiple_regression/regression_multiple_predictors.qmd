...
::: {.column  width="40%"}
![](../../images/pinguins.jpg){width="350px"}
:::
:::
...
ssrTable(cbind(predicted.sales, b.0, b.1, airplay, b.2, adverts)[1:5,],
              rownames = FALSE, height = 300,
...
```{r, echo=FALSE}
ssrTable(data.frame(sales, predicted.sales, error = round(error, 3))[1:5,],
              rownames = FALSE, height = 300,
              options = list(dom = 'Bfrtip',
                             buttons = c('csv')))
```
